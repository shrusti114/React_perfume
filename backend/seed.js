...
const seedDatabase = async () => {
  try {
    ...
    const users = await User.insertMany([
      { _id: 'A001', name: 'Velvora Admin', email: 'admin@velvora.com', password: await pw('admin@123'), role: 'admin', isVerified: true },
      { _id: 'S001', name: 'Chanel Boutique', email: 'chanel@velvora.com', password: await pw('seller@123'), role: 'seller', shopName: 'Chanel Official', isVerified: true },
      { _id: 'S002', name: 'Tom Ford Studio', email: 'tomford@velvora.com', password: await pw('seller@123'), role: 'seller', shopName: 'Tom Ford Atelier', isVerified: true },
      { _id: 'S003', name: 'Dior Perfumery', email: 'dior@velvora.com', password: await pw('seller@123'), role: 'seller', shopName: 'Dior Maison', isVerified: true },
      { _id: 'U001', name: 'Sophia', email: 'sophia@gmail.com', password: await pw('user@123'), role: 'user', isVerified: true },
      { _id: 'U002', name: 'James', email: 'james@gmail.com', password: await pw('user@123'), role: 'user', isVerified: true },
      { _id: 'U003', name: 'Priya', email: 'priya@gmail.com', password: await pw('user@123'), role: 'user', isVerified: true },
    ]);
    console.log('7 Users seeded (1 admin, 3 sellers, 3 users).');

    // Categories
    const categories = await Category.insertMany([
      { _id: 'C001', name: 'Floral', description: 'Romantic rose, jasmine & peony fragrances' },
      { _id: 'C002', name: 'Woody', description: 'Cedar, sandalwood & vetiver compositions' },
      { _id: 'C003', name: 'Fresh', description: 'Citrus, aquatic & green note perfumes' },
      { _id: 'C004', name: 'Oriental', description: 'Amber, vanilla & warm spice blends' },
      { _id: 'C005', name: 'Luxury Collection', description: 'The finest niche fragrances' },
    ]);
    console.log('5 Categories seeded.');

    // Products — 30 real perfumes
    const perfumes = [
      ...
      { _id: 'P013', name: 'Oud Ispahan', brand: 'Dior', price: 380, description: 'A precious oud from Laos with Damask rose in a deep, opulent blend.', family: 'Luxury Collection', gender: 'Unisex', rating: 4.9, badge: 'Exclusive', volume: '125ml', notes: { top: ['Labdanum'], heart: ['Damask Rose', 'Oud'], base: ['Sandalwood', 'Incense'] }, categoryId: 'C005', sellerId: 'S003', stock: 10, image: perfumeImages[16] },
      { _id: 'P014', name: 'Aventus', brand: 'Creed', price: 445, description: 'A bold masculine blend of pineapple, birch and ambergris. The king of perfumes.', family: 'Fresh', gender: 'For Men', rating: 5, badge: 'Award Winner', volume: '100ml', notes: { top: ['Pineapple', 'Apple'], heart: ['Birch', 'Jasmine'], base: ['Ambergris', 'Musk'] }, categoryId: 'C003', sellerId: 'S001', stock: 35, image: perfumeImages[17] },
    ...
    console.log('──────────────────────────────────');
    console.log('Admin:  admin@velvora.com / admin@123');
