    ...
    <div className="bg-neutral-50 dark:bg-black min-h-screen font-sans text-neutral-900 dark:text-neutral-100 transition-colors duration-300">
      ...
      <section className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            { name: "Silk Noir Blazer", desc: "Structured velvet with satin lapels.", price: "₹25,000", img: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=600" },
            { name: "Oversized Cashmere Coat", desc: "Your winter wardrobe staple, redefined.", price: "₹35,000", img: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?q=80&w=600" },
            { name: "Pleated Wide-Leg Trousers", desc: "Fluid movement and sharp tailoring.", price: "₹15,000", img: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?q=80&w=600" }
          ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 relative">
              ...
              <div className="absolute bottom-6 right-6 bg-white/90 dark:bg-black/80 backdrop-blur-md p-4 rounded-xl border border-black/5 dark:border-white/10 shadow-lg">
                ...
                <p className="text-xl font-serif font-bold text-black dark:text-white">₹65,000</p>
              </div>
            </div>
          </div>
        </div>
